<footer class="navbar-fixed-bottom" style="text-align: center">
    <div>
        <div class="col-md-3 col-xs-12">
            Help Make this software Better: <a href="https://github.com/MasterYoshiDev/IONMasterNode">GitHub</a>
        </div>
        <div class="col-md-3 dateupdated hidden-xs hidden-sm">Data Updated: {!! $lastUpdated !!}</div>
        <div class="col-md-3 col-xs-12">Create a Masternode: <a href="https://ionomy.com/masternodes" target="_blank">Ionomy.com</a></div>
