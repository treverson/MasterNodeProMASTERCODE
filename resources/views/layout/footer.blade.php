<footer class="navbar-fixed-bottom" style="text-align: center">
    <div>
        ...
        <div class="col-md-3 hidden-xs hidden-sm">Data Updated: {!! $lastUpdated !!}</div>
        <div class="col-md-3 hidden-xs hidden-sm">Create a Masternode: <a href="https://ionomy.com/masternodes" target="_blank">Ionomy.com</a></div>
