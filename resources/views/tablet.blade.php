        ...
        <div class="col-md-8" style="text-align: center;">
            <div class="mybar col-md-12">
                <div class="col-md-5" style="text-align: center;">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 pull-left blockdetails" style="text-align: left;">
                            ...
                            <div class="col-md-12"><span>{!! $daytilldrop !!}</span> Days until Reward Drop</div>
                        </div>
                ...
                <div class="col-md-5" style="text-align: center;">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <canvas id="do1Chart" width="400" height="400"></canvas>
                            <br>
                            USA
                        </div>
                        <div class="col-md-3">
                            <canvas id="do2Chart" width="400" height="400"></canvas>
                            <br>
                            USA
                        </div>
                        <div class="col-md-3">
                            <canvas id="do3Chart" width="400" height="400"></canvas>
                            <br>
                            USA
                        </div>
                        <div class="col-md-3">
                            <canvas id="do4Chart" width="400" height="400"></canvas>
                            <br>
                            USA
                        </div>
                    </div>
